...
// Los puertos viven en el motor: el lienzo, las plantillas y las pruebas leen el mismo contrato.
export { outputHandles, type OutputHandle } from '@/lib/engine/puertos';
